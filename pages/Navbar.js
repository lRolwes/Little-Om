...
const Navbar = () => {
    return (
        <div className="flex justify-between items-center px-4 font-sans text-lg  font-semibold">
            <Head>
            ...
            <div className="hidden lg:flex text-orange">
                ...
                <div className="px-6 py-4 transition duration-200 hover:-translate-y-1">
